...
class FirestoreData extends ChangeNotifier {
  ...
  Future<Map<String, dynamic>> getTransaction(String transactionID) async {
    ...
    await _fireStore.collection('transactions')
      .doc(transactionID)
      .get().then((DocumentSnapshot<Map<String, dynamic>> documentSnapshot) {
      if (documentSnapshot.exists) {
        ...
        transaction.addAll(<String,dynamic>{'categoryIcon':
        categoriesList[categoryIndex]['icon']});
        ...
        final String stringAmount = NumberFormat
  ...
  Future<void> getData({String walletID = '',
    ...
    if(_auth.currentUser != null) {
      ...
      final List<Map<String, dynamic>> colorData = <Map<String, dynamic>>[];
      ...
      await _fireStore.collection('categories')
        ...
        if (documentSnapshot.docs.isNotEmpty) {
          ...
          category in documentSnapshot.docs) {
      ...
      await _fireStore.collection('walletType')
        ...
        <Map<String, dynamic>> walletType in snapshot.docs) {
      ...
      await _fireStore.collection('wallets')
        ...
        for (final QueryDocumentSnapshot<Map<String, dynamic>> wallet in snapshot.docs) {
      ...
      await _fireStore.collection('transactions')
        ...
        get().then((QuerySnapshot<Map<String, dynamic>> documentSnapshot) {
        if (documentSnapshot.docs.isNotEmpty) {
          for (final QueryDocumentSnapshot
          <Map<String, dynamic>> transaction in documentSnapshot.docs) {
            ...
            final int walletsListIndex = walletsList
                .indexWhere((Map<String, dynamic> element) =>
      ...
      await query.get().then((dynamic documentSnapshot) {
        if (documentSnapshot.docs.length > 0) {
          ...
          for (final dynamic transaction in documentSnapshot.docs) {
            ...
            final double amount = double.parse(transaction.data()['amount'].toString());
  ...
  Future<void> saveTransaction({
    ...
    try{
      ...
      _fireStore.collection('transactions').add(trans);

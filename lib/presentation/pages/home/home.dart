...
import 'package:kwartracker/presentation/widgets/custom_drawer.dart';
...
class _HomePageState extends State<HomePage> with WidgetsBindingObserver {
  ...
  Widget leading() {
    return IconButton(
      ...
      icon: Image.asset('images/icons/ic_menu.ico',
          width: 28, height: 20, fit: BoxFit.fill),
      onPressed: () {
        setState(() {
      ...
      return Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: <
        ...
        Container(
          ...
          child: Column(children: <Widget>[
            Row(children: <Widget>[
              const Expanded(
                child: Text('March 01 - March 30, 2020',
                    style:
                        TextStyle(color: ColorConstants.black, fontSize: 12)),
              ),
              Row(
                crossAxisAlignment: CrossAxisAlignment.end,
                children: <Widget>[
                    ...
                    showModalBottomSheet(
                      ...
                      builder: (BuildContext context) {
                        return StatefulBuilder(builder:
                          ...
                          return pageDefault(context, setState);
                        });
                      },

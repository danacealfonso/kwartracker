...
import 'package:kwartracker/presentation/pages/transactions/transaction_edit.dart';
        ...
        onPressed: () {
          Navigator.push(
              ...
              MyRoute<dynamic>(
                  ...
                  routeSettings:
                      const RouteSettings(name: '/transactionEdit')));
        },
        child: const Padding(
        ...
        child: Row(
          children: <Widget>[
            Expanded(
                child: Text(
              left,
              style: const TextStyle(fontSize: 12, color: ColorConstants.grey6),
            )),
            if (right.isNotEmpty)
              Expanded(
                  child: Text(right,
                      style: const TextStyle(
                          fontSize: 12, color: ColorConstants.grey6))),
          ],
        ),
      );
    }

    Widget info(String left, String right,
        {TextStyle? leftTextStyle, IconData? iconData}) {
      return Padding(
    ...
    Widget content() {
      return Container(
          ...
          child: Container(
            ...
            child: Consumer<FirestoreData>(builder: (BuildContext context,
                        ...
                        Container(
                          ...
                          child: Column(children: <Widget>[
                            Text(
                              ...
                              '${transaction['stringAmount'].toString()}',
                              style: const TextStyle(
                                  fontSize: 40,
                                  fontWeight: FontWeight.w700,
